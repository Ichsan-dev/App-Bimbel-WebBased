...
<html lang="en">
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('Halaman-depan/css/styles.css') }}"
        />
        <link
            rel="stylesheet"
        ...
        <link
            rel="icon"
            type="image/png"
            href="{{ asset('halaman_auth/images/icons/logopalsu.ico') }}"
        />
    ...
    <body>
                        ...
                        >
                            @foreach ($jumbotron as $item)
                                <div class="col-12 col-lg-6">
                                    ...
                                    <a
                                        href="{{ route('formulirpendaftaran') }}"
                                        class="btn mt-5 nav-link cta"
                                        style="color: white"
                                    >
                                        Daftar
                                    </a>
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="d-flex justify-content-end">
                                        <img
                                            src="{{ asset('storage/jumbotron/' . $item->image) }}"
                                            class="hero-img"
                                            alt=""
                                        />
                                    </div>
                        ...
                        @foreach ($kursus as $item)
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="card shadow-sm border-0 rounded">
                                    <img
                                        src="{{ asset('storage/photo-user/' . $item->thumbnail) }}"
                                        class="card-img-top"
                                        alt=""
                                    />
                                    <div class="card-body">
            ...
            <section class="how-it-works" id="how">
                <div class="container">
                    <h2 class="text-dark fw-bold text-center pt-5 pb-3">
                        Mengapa memilih bimbel Rumah Pinus?
                    </h2>
                        ...
                        <div class="row g-5">
                            <div class="col-12 col-lg-6">
                                ...
                                >
                                    ...
                                    <h3
                                        class="fw-bold text-dark how-it-works-title"
                                    >
                                        Kualitas pengajaran
                                    </h3>
                                    <p class="how-it-works-text">
                                        Bimbel Rumah Pinus menawarkan pengajaran
                                        berkualitas tinggi yang disampaikan oleh
                                        instruktur terlatih dan berpengalaman.
                                    </p>
                                </div>
                            </div>
                            <div class="col-12 col-lg-6">
                                ...
                                >
                                    ...
                                    <p class="how-it-works-text">
                                        ...
                                        di Bimbel Rumah Pinus membantu
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                >
                                    ...
                                    <p class="how-it-works-text">
                                        Program pembelajaran disesuaikan dengan
                                        kebutuhan individual setiap siswa,
                                        memastikan pemahaman yang mendalam dan
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                >
                                    ...
                                    <p class="how-it-works-text">
                                        Bimbel Rumah Pinus menggunakan metode
                                        pembelajaran inovatif dan beragam,
                    ...
                    <div id="carouselExample" class="carousel slide">
                        <div class="carousel-inner">
                            ...
                            @foreach ($review as $reviews)
                                <div
                                    class="carousel-item @if($r == 1) active @endif"
                                >
                                    <div class="container py-5">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <img
                                                            src="{{ asset('storage/review/' . $reviews->gambar) }}"
                                                            width="150px"
                                                            class="rounded-circle pb-4"
                                                            alt=""
                                                        />
                                                        <p
                                                            class="testimonial-text pb-2"
                                                        >
                                                            {{ $reviews->komentar }}
                                                        </p>
                                                        <h3
                                                            class="testimonials-name"
                                                        >
                                                            {{ $reviews->nama }}
                                                        </h3>
                                                    </div>
        ...
        <footer>
            <div class="container py-5" id="contact">
                <div class="row" style="text-align: center">
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <a href="bimbelrumahpinus@gmail.com">
                            <i
            ...
            <p class="text-center copyright">
                &copy; 2023 all right reserved by RumahPinus
            </p>
        </footer>
        <script
