        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('JumbotronWebsite')}}" class="nav-link active">
    ...
    <div class="content">
      <div class="container-fluid">
            ...
            <div class="card-header" style="display: flex; justify-content: space-between; align-items:center;">
                <h3 class="card-title" style="margin-bottom: 0;"><b>Jumbotron Table</b></h3>
            </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        <div class="modal fade" id="modal-edit{{$item->id}}">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                    ...
                                    <form action="{{route('JumbotronUpdate', ['id' => $item->id])}}" method="POST" enctype="multipart/form-data"> 
                                            @csrf
                                            @method('PUT')
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Title</label>
                                                <input type="text" class="form-control" id="title" placeholder="" name="vtitle" value="{{ $item->title }}">
                                                    @error('vtitle')
                                                    <small>{{ $message }}</small>
                                                    @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea name="vdescription" id="content" class="form-control">{{ $item->description }}</textarea>
                                                    @error('vdescription')
                                                    <small>{{ $message }}</small>
                                                    @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('storage/jumbotron/'.$item->image)}}" alt="Current Image" style="max-width: 200px;">
                                            </div>
                                        </div>
