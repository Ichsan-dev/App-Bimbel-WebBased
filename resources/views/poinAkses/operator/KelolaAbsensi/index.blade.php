        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('KelolaAbsensi')}}" class="nav-link active">
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer" style="display: flex; justify-content: flex-end;">
                                    <form action="{{route('AbsensiDelete', ['id' => $item->id])}}" method="POST">
                                      @csrf
                                      @method('DELETE')
                    ...
                    <div class="modal fade" id="modal-edit{{$item->id}}">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                      ...
                                      <form action="{{route('AbsensiUpdate', ['id' => $item->id])}}" method="POST" enctype="multipart/form-data"> 
                                              @csrf
                                              @method('PUT')
                                          <div class="modal-body">
                                              ...
                                              <div class="form-group">
                                                  <label for="exampleInputNama">Tanggal</label>
                                                  <input type="date" class="form-control" id="tanggal" placeholder="yyyy-mm-dd" name="tanggal" value="{{$item->tanggal}}">
                                                      @error('tanggal')
                                                          <small>{{ $message }}</small>
                                                      @enderror
                                              </div>
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" id="catatan" placeholder="Cth: Sakit Batuk" name="catatan" value="{{$item->catatan}}">
                                                      @error('catatan')
                                                          <small>{{ $message }}</small>
                                                      @enderror
                                              </div>
                  ...
                  <div class="modal-content">
                      ...
                      <form action="{{route('AbsensiStore')}}" method="POST" enctype="multipart/form-data"> 
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                  <label for="exampleInputNama">Tanggal</label>
                                  <input type="date" class="form-control" id="tanggal" placeholder="yyyy-mm-dd" name="tanggal" value="">
                                      @error('tanggal')
                                          <small>{{ $message }}</small>
                                      @enderror
                              </div>
                              ...
                              <div class="form-group">
                                  <label for="exampleInputNama">Keterangan</label>
                                  <input type="text" class="form-control" id="catatan" placeholder="Cth: Sakit Batuk" name="catatan" value="">
                                      @error('catatan')
                                          <small>{{ $message }}</small>
                                      @enderror
                              </div>
